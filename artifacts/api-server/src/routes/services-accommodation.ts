...
import { accommodationMgt, contracts, users } from "@workspace/db/schema";
...
router.post(
  "/api/services/accommodation/:id/welfare-check",
  authenticate,
  requireRole(...STAFF_ROLES),
  async (req, res) => {
    try {
