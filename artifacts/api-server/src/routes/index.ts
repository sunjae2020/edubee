...
import accountingJeMappingsRouter from "./accounting-je-mappings.js";
import invoiceSchedulesRouter from "./invoice-schedules.js";
import incentiveTiersRouter from "./incentive-tiers.js";
...
router.use(accountingJeMappingsRouter);
router.use(invoiceSchedulesRouter);
router.use(incentiveTiersRouter);
