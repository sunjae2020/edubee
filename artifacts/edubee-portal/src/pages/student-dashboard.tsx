  ...
  return (
    <div className="rounded-xl p-5 border" style={{ background: "var(--e-bg-surface)", borderColor: "var(--e-border)", boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
      <div className="flex items-start justify-between">
        ...
        <div className="p-2.5 rounded-lg" style={{ background: "var(--e-orange-lt)" }}>
          ...
          <Link href="/student/quotes">
            <a className="block rounded-xl p-5 border cursor-pointer transition-all hover:border-orange-300"
              ...
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-semibold" style={{ color: "var(--e-text-1)" }}>My Quotes</span>
              </div>
          ...
          <Link href="/student/programs">
            <a className="block rounded-xl p-5 border cursor-pointer transition-all hover:border-orange-300"
              ...
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-semibold" style={{ color: "var(--e-text-1)" }}>My Programs</span>
              </div>
