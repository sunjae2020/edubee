            ...
            {["note","call","email","meeting","demo"].map(t => {
              ...
              return (
                <button key={t} onClick={() => set("activityType", t)}
                  ...
                  style={{
                    borderColor: form.activityType === t ? "var(--e-orange)" : "#E8E6E2",
                    background: form.activityType === t ? "var(--e-orange-lt)" : "white",
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-sm mx-4">
        ...
        <div className="p-5 space-y-3">
          {err && <p className="text-xs text-red-600 bg-red-50 px-3 py-2 rounded">{err}</p>}
          {[
            { k: "fullName", label: "Full Name *", placeholder: "John Smith" },
