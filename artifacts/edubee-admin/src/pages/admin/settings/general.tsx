          ...
          <section className="bg-white rounded-xl border p-5 space-y-4">
            ...
            <div className="rounded-lg bg-(--e-orange-lt) border border-(--e-orange)/20 px-4 py-3 text-xs text-[#92400E] space-y-1">
              ...
              <ol className="list-decimal list-inside space-y-0.5 text-[#A16207]">
                ...
                <li>Enter the API key and sending email address in the fields below, then save</li>
              </ol>
            </div>
              ...
              <div className="sm:col-span-2">
                ...
                {resendData?.hasApiKey && (
                  <p className="text-xs text-green-600 flex items-center gap-1 mt-1">
                    <CheckCircle2 className="w-3 h-3" /> An API key is saved. Enter a new key to update it.
                  </p>
                )}
              </div>
              <div>
                <Label className="text-xs">Sending Email Address (From)</Label>
                <Input
                  value={resend.from}
                ...
                />
                <p className="text-[10px] text-muted-foreground mt-1">Must be an email on a domain verified in Resend.</p>
              </div>
              <div>
