...
const features = [
  'Head office & overseas branch integration',
  'Consultant KPI dashboard',
      ...
      <section className="py-20 bg-white border-b border-neutral-200 relative overflow-hidden">
        ...
        <div className="max-w-[800px] mx-auto px-6 relative z-10">
          <FadeIn>
            ...
            <h1 className="text-[32px] font-bold text-neutral-900 mb-6">{t('home.services.s6Title')}</h1>
            <p className="text-base text-neutral-600 leading-relaxed mb-10">{t('home.services.s6Body')}</p>
