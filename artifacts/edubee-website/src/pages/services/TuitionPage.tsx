...
const features = [
  'Per-student total tuition tracking',
  'Term-by-term tuition breakdown',
  'Commission rate configuration',
  'Commission receipt reminders',
          ...
          <FadeIn>
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-xl bg-[#FEF0E3] flex items-center justify-center">
                <CreditCard size={24} className="text-[#F5821F]" />
              </div>
              <span className="text-xs font-semibold uppercase tracking-widest text-[#F5821F]">Service</span>
            </div>
            <h1 className="text-[32px] font-bold text-neutral-900 mb-6">{t('home.services.s5Title')}</h1>
            <p className="text-base text-neutral-600 leading-relaxed mb-10">{t('home.services.s5Body')}</p>
