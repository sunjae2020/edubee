...
const features = [
  ...
  'School-specific document requirements',
          ...
          <FadeIn>
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-xl bg-[#FEF0E3] flex items-center justify-center">
                <BookOpen size={24} className="text-[#F5821F]" />
              </div>
              <Badge variant="new">{t('common.newBadge')}</Badge>
            </div>
            <h1 className="text-[32px] font-bold text-neutral-900 mb-6">{t('home.ai.studyTitle')}</h1>
            <p className="text-base text-neutral-600 leading-relaxed mb-10">{t('home.ai.studyBody')}</p>
