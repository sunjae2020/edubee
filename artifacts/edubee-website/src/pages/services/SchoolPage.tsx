...
const features = [
  'Country-by-country school database',
  'Degree & program classification',
  'School commission rate setting',
  'Commission payment schedule alerts',
  'Performance analytics by country, school, program',
]
          ...
          <FadeIn>
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-xl bg-[#FEF0E3] flex items-center justify-center">
                <School size={24} className="text-[#F5821F]" />
              </div>
              <span className="text-xs font-semibold uppercase tracking-widest text-[#F5821F]">Service</span>
            </div>
            <h1 className="text-[32px] font-bold text-neutral-900 mb-6">{t('home.services.s2Title')}</h1>
            <p className="text-base text-neutral-600 leading-relaxed mb-10">{t('home.services.s2Body')}</p>
