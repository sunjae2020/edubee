    ...
    <button
      ...
      className={`p-1.5 rounded transition-colors text-sm
        ${active
          ...
          : "text-[#57534E] hover:bg-[#F5821F]/10 hover:text-[#F5821F]"}
...
export function RichTextEditor({ value, onChange, placeholder, minHeight = 200 }: RichTextEditorProps) {
  ...
  return (
    <div className="rounded-lg border border-[#E8E6E2] overflow-hidden focus-within:border-[#F5821F] focus-within:shadow-[0_0_0_3px_rgba(245,130,31,0.15)] transition-all">
      {/* Toolbar */}
