      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-20 right-4 z-50 w-[360px] sm:w-[380px] flex flex-col shadow-2xl rounded-2xl overflow-hidden border border-white/30 backdrop-blur-xl"
            style={{ maxHeight: "calc(100vh - 120px)", height: 520, background: "rgba(255,255,255,0.82)" }}
          >
            {/* Header */}
            ...
            {/* Messages */}
            <div className="flex-1 overflow-y-auto px-4 py-3 space-y-3" style={{ background: "rgba(248,248,248,0.7)" }}>
              {messages.map((msg, i) => (
            ...
            {/* Input */}
            <div className="shrink-0 px-3 py-3" style={{ borderTop: "1px solid rgba(0,0,0,0.08)", background: "rgba(255,255,255,0.88)" }}>
              <div
