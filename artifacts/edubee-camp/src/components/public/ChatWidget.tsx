...
export function ChatWidget() {
  ...
  const send = useCallback(async (question: string) => {
    ...
    try {
      ...
      setMessages(prev => {
        ...
        u[u.length - 1] = {
          role: "assistant",
          content: text || "Failed to load the response.",
  ...
  const reset = () => {
    setMessages([{
      role: "assistant",
      content: "Conversation has been reset. Please enter a new question! 😊",
    }]);
  };
            ...
            <div className="shrink-0 flex items-center justify-between px-4 py-3 bg-(--e-orange)">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-white/75 leading-tight">Gemini 2.5 · Knowledge base powered answers</p>
                </div>
              </div>
