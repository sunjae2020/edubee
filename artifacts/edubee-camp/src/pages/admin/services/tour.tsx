...
import { Map, Pencil, ChevronRight } from "lucide-react";
          ...
          <tbody className="divide-y divide-border">
            {isLoading ? (
              ...
              <tr><td colSpan={8} className="px-4 py-16 text-center text-muted-foreground text-sm">
                <Map className="w-8 h-8 mx-auto mb-3 opacity-30" />No tour records found
              </td></tr>
            ) : rows.map(r => (
            ...
            <div className="mt-4 space-y-4">
              ...
              {!editing ? (
                <dl className="space-y-3">
                  {[
                    ["Student", selected.studentName], ["Tour Name", selected.tourName],
