...
function ParticipantsTab({
  ...
  const { data, isLoading } = useQuery({
    queryKey: ["camp-contract-participants", applicationId],
  ...
  const updateParticipant = useMutation({
    ...
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["camp-contract-participants", applicationId] });
...
export default function CampContractDetail() {
  ...
  const updateContract = useMutation({
    ...
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["camp-contract-detail-page", id] });
  ...
  return (
    <>
      <DetailPageLayout
        ...
        backPath="/admin/camp-contracts"
        backLabel="Camp Contract"
        tabs={TABS}
        activeTab={activeTab}
