  ...
  if (!entry) {
    return (
      <div className="flex flex-col items-center justify-center py-24 text-[#A8A29E]">
        ...
        <Button variant="link" className="text-[#F5821F] mt-2" onClick={() => navigate("/admin/accounting/journal")}>
    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <BookOpen className="w-5 h-5 text-[#F5821F]" strokeWidth={1.5} />
          <h1 className="text-xl font-bold text-[#1C1917] leading-none">Journal Entry</h1>
          {entry.entryType && (
            <span className="px-2.5 py-0.5 rounded-full text-xs font-medium bg-[#FEF0E3] text-[#F5821F]">
              {entry.entryType}
            </span>
          )}
        </div>
      ...
      <div className="bg-white rounded-xl border border-[#E8E6E2] shadow-[0_1px_3px_rgba(0,0,0,0.06)] p-6 space-y-5">
        ...
        <div className="border-t border-[#F4F3F1] pt-5 space-y-5">
          <h3 className="text-xs font-semibold uppercase tracking-widest text-[#F5821F]">Journal Lines</h3>
