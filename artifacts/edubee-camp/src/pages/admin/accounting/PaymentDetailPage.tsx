  ...
  if (!payment) {
    return (
      <div className="flex flex-col items-center justify-center py-24 text-[#A8A29E]">
        ...
        <Button variant="link" className="text-[#F5821F] mt-2" onClick={() => navigate("/admin/accounting/payments")}>
          Back to Payments
        </Button>
      </div>
    );
      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <CreditCard className="w-5 h-5 text-[#F5821F]" strokeWidth={1.5} />
      ...
      <div className="bg-white rounded-xl border border-[#E8E6E2] shadow-[0_1px_3px_rgba(0,0,0,0.06)] p-6 space-y-5">
        ...
        <div className="grid grid-cols-2 gap-x-8 gap-y-5">
          ...
          <InfoRow label="Payment Type" value={
            <span className="px-2 py-0.5 rounded text-xs font-medium bg-[#FEF0E3] text-[#F5821F]">
              {payment.paymentType}
            </span>
          } />
              ...
              {payment.journalEntries.map(je => (
                <tr key={je.id}
                  ...
                  <td className="px-6 py-3 text-[#57534E] text-xs">
                    <span className="font-mono font-bold text-[#F5821F] mr-1">{je.debitCoa}</span>
