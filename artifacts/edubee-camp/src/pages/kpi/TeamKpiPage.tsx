      ...
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-[10px] flex items-center justify-center shrink-0 bg-[#FEF0E3]">
            <Users className="w-5 h-5 text-[#F5821F]" strokeWidth={1.8} />
          </div>
          <div>
      ...
      {data && !loading && (
        <>
          <div className="flex items-center gap-3 px-1">
            ...
            <span className="text-xs px-2.5 py-1 bg-[#FEF0E3] text-[#F5821F] rounded-full font-medium border border-[#F5821F]/20">
            ...
            <div className="divide-y divide-[#F4F3F1]">
              {data.members.map(member => (
                <div key={member.staffId}>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className="w-7 h-7 rounded-full bg-[#FEF0E3] flex items-center justify-center shrink-0">
                        <span className="text-xs font-bold text-[#F5821F]">
                    ...
                    <div className="flex items-center gap-3">
                      <span className="text-sm font-semibold text-[#F5821F]">{fmt(member.netRevenue)}</span>
      ...
      {!selectedTeamId && !loading && (
        <div className="flex flex-col items-center py-16 gap-3">
          <div className="w-12 h-12 rounded-2xl bg-[#FEF0E3] flex items-center justify-center">
            <Users className="w-6 h-6 text-[#F5821F]" strokeWidth={1.5} />
          </div>
