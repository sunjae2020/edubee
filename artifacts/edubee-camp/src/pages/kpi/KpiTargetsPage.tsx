...
const INPUT_CLS =
  ...
  'placeholder:text-[#A8A29E] focus:outline-none focus:ring-2 focus:ring-[#F5821F]/40 ' +
  'focus:border-[#F5821F] transition-colors';
...
export default function KpiTargetsPage() {
  ...
  return (
    <div className="p-6 space-y-5 max-w-5xl mx-auto">
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-[10px] flex items-center justify-center shrink-0 bg-[#FEF0E3]">
            <Target className="w-5 h-5 text-[#F5821F]" strokeWidth={1.8} />
          </div>
          <div>
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-semibold
            ...
            hover:shadow-[0_4px_12px_rgba(245,130,31,0.25)] active:bg-[#C25E08] transition-all"
        >
      ...
      {showForm && (
        <div className="bg-white rounded-xl border border-[#F5821F]/30 p-5 space-y-4"
          style={{ boxShadow: '0 4px_16px_rgba(245,130,31,0.08)' }}>
          ...
          <div className="flex gap-2 pt-2 border-t border-[#E8E6E2]">
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg text-sm font-semibold
                bg-[#F5821F] text-white hover:bg-[#D96A0A] hover:-translate-y-px
                hover:shadow-[0_4px_12px_rgba(245,130,31,0.25)] disabled:opacity-50
                ...
                <tr key={t.id} className="hover:bg-[#FAFAF9] transition-colors">
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2">
                      {t.staffName
                        ? <>
                            <div className="w-6 h-6 rounded-full bg-[#FEF0E3] flex items-center justify-center shrink-0">
                              <User className="w-3 h-3 text-[#F5821F]" />
                            </div>
                  ...
                  <td className="px-4 py-3 font-semibold text-[#F5821F]">
                  ...
                  <td className="px-4 py-3 text-[#57534E]">
                    ...
                    {t.incentiveType === 'percentage' && t.incentiveRate &&
                      <span className="ml-1 text-xs font-medium text-[#F5821F]">
                  ...
                  <td className="px-4 py-3">
                    <button
                      ...
                      className="inline-flex items-center gap-1 text-xs font-medium text-[#57534E]
                        hover:text-[#F5821F] transition-colors"
                    >
